# Generated by Django 4.2.6 on 2024-03-17 17:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('jery', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.jery')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('score', models.IntegerField()),
                ('credit', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.critère')),
                ('défi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.défi')),
                ('équipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.équipe')),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('critere', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.critère')),
                ('defi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.défi')),
            ],
        ),
        migrations.CreateModel(
            name='EvaluationJury',
            fields=[
                ...
                ('membre_jury', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.jery')),
                ('soumission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.soumission')),
            ],
        ),
        migrations.CreateModel(
